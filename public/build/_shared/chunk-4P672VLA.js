...
var reducer_default = immer_esm_default(function reducer(draft, { action, ...rest }) {
  ...
  switch (action) {
    ...
    case "set-server-basket": {
      draft.serverBasket = rest.serverBasket;
      draft.status = "ready";
      if (window.ENV.NEXT_PUBLIC_CRYSTALLIZE_TENANT_IDENTIFIER !== "furniture" && window.ENV.SERVICE_API_URL === "https://3001-cs-138832141934-default.cs-europe-west4-bhnf.cloudshell.dev/api/graphql") {
...
async function serviceApi({
  uri = `https://3001-cs-138832141934-default.cs-europe-west4-bhnf.cloudshell.dev/api/graphql`,
  query,
  variables
}) {
...
//# sourceMappingURL=/build/_shared/chunk-4P672VLA.js.map
