...
var reducer_default = immer_esm_default(function reducer(draft, { action, ...rest }) {
  ...
  switch (action) {
    ...
    case "set-server-basket": {
      draft.serverBasket = rest.serverBasket;
      draft.status = "ready";
      if (window.ENV.NEXT_PUBLIC_CRYSTALLIZE_TENANT_IDENTIFIER !== "furniture" && window.ENV.SERVICE_API_URL === "https://remix-service-r44maju05-aleksep-gmailcom.vercel.app/api/graphql") {
...
async function serviceApi({
  uri = `https://remix-service-r44maju05-aleksep-gmailcom.vercel.app/api/graphql`,
  query,
  variables
}) {
...
//# sourceMappingURL=/build/_shared/chunk-T6EPN4LW.js.map
