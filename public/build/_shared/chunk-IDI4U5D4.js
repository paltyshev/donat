...
var reducer_default = immer_esm_default(function reducer(draft, { action, ...rest }) {
  ...
  switch (action) {
    ...
    case "set-server-basket": {
      draft.serverBasket = rest.serverBasket;
      draft.status = "ready";
      if (window.ENV.NEXT_PUBLIC_CRYSTALLIZE_TENANT_IDENTIFIER !== "furniture" && window.ENV.SERVICE_API_URL === "https://remix-service-86gdw1dxu-aleksep-gmailcom.vercel.app/api/graphql") {
...
//# sourceMappingURL=/build/_shared/chunk-IDI4U5D4.js.map
