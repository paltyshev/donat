import {
  componentContent,
  require_dist
} from "/build/_shared/chunk-AWOHBAQP.js";
...
var require_react_content_transformer_cjs_development = __commonJS({
  "node_modules/@crystallize/react-content-transformer/dist/react-content-transformer.cjs.development.js"(exports) {
    ...
    var OverridesContext = /* @__PURE__ */ React7.createContext(null);
    var NodeContent = function NodeContent2(props) {
      ...
      if (props.children) {
        return React__default.createElement(React7.Fragment, null, props.children.map(function(child, i) {
    ...
    function renderTextContent(text) {
      ...
      if (partsBetweenLineBreaks.length === 1) {
        return React__default.createElement(React7.Fragment, null, text);
      }
      return React__default.createElement(React7.Fragment, null, partsBetweenLineBreaks.map(function(part, index) {
        var key = index.toString();
        if (index === partsBetweenLineBreaks.length - 1) {
          return React__default.createElement(React7.Fragment, {
            key
          }, "part");
        }
        return React__default.createElement(React7.Fragment, {
    ...
    var ContentTransformerNode = function ContentTransformerNode2(props) {
      ...
      var overrides = React7.useContext(OverridesContext);
...
var ProductBody = ({ body, table }) => {
  return /* @__PURE__ */ import_react.default.createElement("div", {
    ...
    }, paragraph.title && /* @__PURE__ */ import_react.default.createElement("h2", {
      className: "font-semibold text-2xl mb-4"
    }, paragraph == null ? void 0 : paragraph.title.text), paragraph.body && /* @__PURE__ */ import_react.default.createElement("div", null, /* @__PURE__ */ import_react.default.createElement(import_react_content_transformer.ContentTransformer, {
      json: (_a = paragraph.body) == null ? void 0 : _a.json
    }))), paragraph.images && /* @__PURE__ */ import_react.default.createElement("div", {
      className: "my-5"
    }, (_b = paragraph == null ? void 0 : paragraph.images) == null ? void 0 : _b.map((image) => /* @__PURE__ */ import_react.default.createElement(import_react_image.Image, {
      ...image,
      sizes: "200px",
      className: "rounded-xl overflow-hidden",
      loading: "lazy"
    }))), paragraph.videos && /* @__PURE__ */ import_react.default.createElement("div", {
      className: "my-5"
    }, /* @__PURE__ */ import_react.default.createElement(import_react_player.default, {
      controls: true,
  ...
  }), componentContent(table == null ? void 0 : table.content, "PropertiesTableContent").sections.map((section, index) => /* @__PURE__ */ import_react.default.createElement("div", {
    key: index,
  ...
  }, section == null ? void 0 : section.title), /* @__PURE__ */ import_react.default.createElement("p", {
    className: "italic"
  }, "\u0431\u0443\u043A\u0435\u0442\u0430")), /* @__PURE__ */ import_react.default.createElement("div", {
    className: "lg:w-7/12 w-full"
  }, section.properties.map((property, index2) => /* @__PURE__ */ import_react.default.createElement("div", {
    key: index2,
    className: "flex justify-between my-3 even:bg-grey px-5 py-2"
  }, /* @__PURE__ */ import_react.default.createElement("p", null, property.key), /* @__PURE__ */ import_react.default.createElement("p", null, property.value)))))));
};
...
var VariantSelector = ({
  ...
  return /* @__PURE__ */ import_react2.default.createElement("div", null, Object.keys(attributes).map((attribute) => {
    ...
    }, attribute), /* @__PURE__ */ import_react2.default.createElement("div", {
      className: "flex justify-between mb-5"
    }, attr.map((value) => /* @__PURE__ */ import_react2.default.createElement("button", {
      key: value,
...
var RelatedProducts = ({ related }) => {
  return /* @__PURE__ */ import_react3.default.createElement("div", {
    ...
    var _a;
    return /* @__PURE__ */ import_react3.default.createElement(Link, {
      prefetch: "intent",
      to: item.path,
      key: index,
    ...
    }, (_a = item.topics) == null ? void 0 : _a.map((topic) => /* @__PURE__ */ import_react3.default.createElement("div", {
      className: "text-sm bg-grey px-2 py-1 rounded-2xl",
      key: topic.name
    }, topic.name))), /* @__PURE__ */ import_react3.default.createElement("div", null, "$", componentContent(item, "Product").defaultVariant.price)), /* @__PURE__ */ import_react3.default.createElement(import_react_image2.Image, {
...
var Product = ({ product }) => {
  ...
  const [selectedVariant, setSelectedVariant] = (0, import_react4.useState)(item.variants[0]);
  ...
  }, item.name), /* @__PURE__ */ import_react5.default.createElement(import_react_content_transformer2.ContentTransformer, {
    json: (_a = componentContent(item.summary.content, "RichTextContent")) == null ? void 0 : _a.json
  })), /* @__PURE__ */ import_react5.default.createElement(import_react_image3.Image, {
    ...item.defaultVariant.firstImage,
    sizes: "400px",
    className: "w-full rounded-sm"
  }), /* @__PURE__ */ import_react5.default.createElement("div", {
    className: "flex flex-col"
  }, /* @__PURE__ */ import_react5.default.createElement(VariantSelector, {
  ...
  }, "\u0418\u0442\u043E\u0433\u043E"), /* @__PURE__ */ import_react5.default.createElement("p", {
    className: "font-bold text-lg"
  }, "$", selectedVariant.price)), /* @__PURE__ */ import_react5.default.createElement("button", {
    onClick: () => buy(),
    className: "bg-background2 px-4 rounded-xl"
  }, "\u041A\u0443\u043F\u0438\u0442\u044C")), /* @__PURE__ */ import_react5.default.createElement("div", null, /* @__PURE__ */ import_react5.default.createElement(ProductBody, {
    body: item.body,
    table: item.table
  }), /* @__PURE__ */ import_react5.default.createElement("p", {
    className: "text-text mb-4 font-semibold"
  }, "\u041F\u043E\u0445\u043E\u0436\u0438\u0435 \u0431\u0443\u043A\u0435\u0442\u044B")), /* @__PURE__ */ import_react5.default.createElement(RelatedProducts, {
...
function Index() {
  ...
  }), /* @__PURE__ */ import_react6.default.createElement(Product, {
 ...
 */
//# sourceMappingURL=/build/routes/shop/$product-E2TRZ75D.js.map
