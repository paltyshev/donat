...
// browser-route-module:/home/aleksep/remix/donat/app/routes/index.tsx?browser
init_react();

// app/routes/index.tsx
init_react();
var import_react3 = __toESM(require_react3());
...
var GridItem = ({ cell }) => {
  ...
  return cell.layout.colspan === 3 ? /* @__PURE__ */ import_react.default.createElement(Link, {
    to: (_a = cell == null ? void 0 : cell.item) == null ? void 0 : _a.path,
    prefetch: "intent"
  }, /* @__PURE__ */ import_react.default.createElement("div", {
    className: "flex relative lg:flex-row flex-col"
  }, /* @__PURE__ */ import_react.default.createElement(import_react_image.Image, {
  ...
  }, (_d = cell == null ? void 0 : cell.item) == null ? void 0 : _d.name), /* @__PURE__ */ import_react.default.createElement("p", {
    className: "mt-4"
  }, "$", (_f = (_e = cell.item) == null ? void 0 : _e.variants[0]) == null ? void 0 : _f.price)), /* @__PURE__ */ import_react.default.createElement("div", {
    className: "flex gap-1"
  }, (_h = (_g = cell.item) == null ? void 0 : _g.topics) == null ? void 0 : _h.map((topic) => /* @__PURE__ */ import_react.default.createElement("div", {
    className: "text-sm bg-grey px-2 py-1 rounded-2xl",
    key: topic.name
  }, topic.name)))))) : /* @__PURE__ */ import_react.default.createElement(Link, {
    to: cell.item.path,
    prefetch: "intent"
  }, /* @__PURE__ */ import_react.default.createElement("div", {
    ...
    className: "flex gap-1"
  }, (_i = cell.item.topics) == null ? void 0 : _i.map((topic) => /* @__PURE__ */ import_react.default.createElement("div", {
    className: "text-sm bg-grey px-2 py-1 rounded-2xl",
    key: topic.name
  }, topic.name))), /* @__PURE__ */ import_react.default.createElement("p", {
    className: "self-end"
  }, "$", (_j = cell.item.variants[0]) == null ? void 0 : _j.price)), /* @__PURE__ */ import_react.default.createElement(import_react_image.Image, {
...
var Products = ({ donuts }) => {
  ...
  return /* @__PURE__ */ import_react2.default.createElement("div", {
  ...
  }, "Our do(u)nuts"), /* @__PURE__ */ import_react2.default.createElement("div", {
    ...
    return !((_b = componentContent((_a2 = donut == null ? void 0 : donut.bundle) == null ? void 0 : _a2.content, "BooleanContent")) == null ? void 0 : _b.value) && donut.bundle ? /* @__PURE__ */ import_react2.default.createElement(Link, {
      ...
      className: "flex gap-1"
    }, (_c = donut == null ? void 0 : donut.topics) == null ? void 0 : _c.map((topic, index2) => /* @__PURE__ */ import_react2.default.createElement("div", {
      className: "text-sm bg-grey px-2 py-1 rounded-2xl",
      key: index2
    }, topic.name))), /* @__PURE__ */ import_react2.default.createElement("p", {
      className: "self-end"
    }, "$", (_d = componentContent(donut, "Product")) == null ? void 0 : _d.defaultVariant.price)), /* @__PURE__ */ import_react2.default.createElement(import_react_image2.Image, {
...
function Index() {
  ...
  const children = ({ cells }) => {
    return cells.map((cell, index) => /* @__PURE__ */ import_react4.default.createElement("div", {
      style: {
      ...
      id: "grid-item",
      key: "cell" + index
    }, /* @__PURE__ */ import_react4.default.createElement(GridItem, {
      cell
    })));
  };
  ...
  }), /* @__PURE__ */ import_react4.default.createElement(import_react3.default, {
    model: grid.content.grids[0],
    className: "gap-5"
  }, children), /* @__PURE__ */ import_react4.default.createElement(Products, {
    donuts
  }));
}
export {
...
//# sourceMappingURL=/build/routes/index-U7HRTTZ2.js.map
