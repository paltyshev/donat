...
var StripePayment = ({ checkoutModel, onSuccess }) => {
  return /* @__PURE__ */ import_react2.default.createElement(InvoiceForm, {
    checkoutModel,
    onSuccess
  });
};
var Invoice = ({ checkoutModel, onSuccess }) => {
  return /* @__PURE__ */ import_react2.default.createElement(StripePayment, {
    checkoutModel,
    onSuccess
  });
};
...
var Payments = (props) => {
  ...
  return /* @__PURE__ */ import_react4.default.createElement(import_react4.default.Fragment, null, /* @__PURE__ */ import_react4.default.createElement(Invoice, {
    ...props
  }));
};
...
function Checkout() {
  ...
  }, "\u041E\u0444\u043E\u0440\u043C\u043B\u0435\u043D\u0438\u0435 \u0437\u0430\u043A\u0430\u0437\u0430"), /* @__PURE__ */ import_react6.default.createElement("div", {
    className: "mx-auto"
  ...
  }))), /* @__PURE__ */ import_react6.default.createElement(Payments, {
    checkoutModel,
...
//# sourceMappingURL=/build/routes/checkout-TBDM4KZJ.js.map
